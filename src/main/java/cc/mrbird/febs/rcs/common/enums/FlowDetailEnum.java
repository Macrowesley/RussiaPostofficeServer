...
public enum FlowDetailEnum {
    ...
    JobingPcClickPrintResOk(71,"未闭环：点击PC打印按钮，得到了机器返回结果ok"),
    JobingPcClickPrintResFail(72,"未闭环：点击PC打印按钮，得到了机器返回结果失败"),
    JobingPcCancelResOk(73,"未闭环：点击PC的取消按钮，得到了机器返回结果ok"),
    JobingPcCancleResFail(74,"未闭环：点击PC的取消按钮，得到了机器返回结果失败"),
