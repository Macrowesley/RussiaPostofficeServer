...
//    private static final int INITIALIZE_LENGTH = 1024;
    ...
    public static String decryptDataOnJava(String data, String PRIVATEKEY) {
        ...
        try {
            ...
            log.error("java端私钥解密异常：" + e.getMessage());
        }
        return temp;
    }
...
//        content = "";
        ...
        //公钥加密后内容
        String encryptedContent = encryptedDataOnJava(content, publicKey);
        System.out.println("公钥加密后内容长度: " + encryptedContent.length() + " 内容：" + encryptedContent);
